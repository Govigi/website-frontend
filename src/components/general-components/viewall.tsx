          ...
          <div className="py-3 md:py-4 px-1 md:px-2 w-full">
            <button
              ...
              className={`w-full mb-3 md:mb-4 flex flex-col items-center transition-all ${
                !category ? 'opacity-100' : 'opacity-60 hover:opacity-100'
              }`}
            >
            ...
            {categories.map((cat) => (
              <button
                ...
                className={`w-full mb-3 md:mb-4 flex flex-col items-center transition-all ${
                  category === cat.categoryName ? 'opacity-100' : 'opacity-60 hover:opacity-100'
                }`}
              >
                <div className={`w-12 h-12 md:w-14 md:h-14 lg:w-16 lg:h-16 rounded-md overflow-hidden mb-1.5 md:mb-2 border-2 transition-all ${
        ...
        <div className="flex-1 overflow-y-auto bg-white">
          {loading ? (
            ...
            <div className="p-3 sm:p-4 md:p-5 lg:p-6">
              {/* Products Count & Category Title */}
              <div className="mb-4 md:mb-5 max-w-7xl mx-auto">
