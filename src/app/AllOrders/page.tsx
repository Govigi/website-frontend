...
import { ChevronDownIcon, CalendarIcon, UserIcon, ShoppingBagIcon, ArrowDownTrayIcon } from "@heroicons/react/24/outline";
...
export default function AllOrdersPage() {
  ...
  const API_URL = config.backend_url + "/getAllOrders";
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-gray-100 flex items-center justify-center p-4">
        <div className="text-center space-y-4 max-w-md">
          ...
          <button onClick={() => window.location.reload()} className="mt-4 px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg font-medium transition-colors">
            Try Again
          </button>
        </div>
      </div>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-gray-100 flex items-center justify-center p-4">
        <div className="text-center space-y-4 max-w-md">
          ...
          <button onClick={() => window.location.href = '/webapp'} className="mt-4 px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg font-medium transition-colors">
            Start Shopping
          </button>
        </div>
      </div>
            ...
            >
              <div className="bg-white rounded-xl shadow-sm hover:shadow-lg border border-gray-200 hover:border-green-300 transition-all duration-300 overflow-hidden">
                  ...
                  {order.scheduledDate && (
                    <div className="mt-4 pt-4 border-t border-gray-100 flex items-center gap-2 text-sm">
                      ...
                      <span className="text-gray-600">
                        Scheduled for: <span className="font-medium text-gray-900">
                ...
                {expandedOrder === order._id && (
                  <div className="border-t border-gray-100 bg-gray-50/50 animate-in fade-in slide-in-from-top-2 duration-300">
                            ...
                            >
                              ...
                              <div className="w-full h-24 bg-gray-100 rounded-lg flex items-center justify-center overflow-hidden mb-3 group-hover/item:bg-gray-50 transition-colors">
                                <img
                                  ...
                                  onError={(e) => {
                                    e.currentTarget.src = "/api/placeholder/120/96";
                                  }}
                                />
                              </div>
