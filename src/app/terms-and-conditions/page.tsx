    ...
    <div className="min-h-screen bg-[#ffffff] font-sans">
      ...
      <main className="pt-[120px] pb-[60px] px-[20px] max-w-[1080px] mx-auto">
        ...
        <div className="text-[14px] leading-[1.6] text-[#3d4152]">
          <h2 className="text-[16px] font-[700] text-[#282c3f] mt-[24px] mb-[12px]">General Information</h2>
          <p className="mb-[16px]">
          ...
          <p className="mb-[16px]">
            2. This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name www.govigi.com ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
          </p>
          <p className="mb-[16px]">
            3. The Platform is owned by Govigi, a company incorporated under the Companies Act, 1956 with its registered office at Peddapuram (hereinafter referred to as 'Platform Owner', 'we', 'us', 'our').
          </p>
          <p className="mb-[16px]">
          ...
          <h2 className="text-[16px] font-[700] text-[#282c3f] mt-[24px] mb-[12px]">Use of Platform</h2>
          <p className="mb-[16px]">7. The use of Platform and/or availing of our Services is subject to the following Terms of Use:</p>
          ...
          <h2 className="text-[16px] font-[700] text-[#282c3f] mt-[24px] mb-[12px]">Indemnification & Liability</h2>
          <p className="mb-[16px]">
          ...
          <h2 className="text-[16px] font-[700] text-[#282c3f] mt-[24px] mb-[12px]">Dispute Resolution</h2>
          <p className="mb-[16px]">
