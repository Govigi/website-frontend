        ...
        <div className="bg-white shadow-xl rounded-3xl p-10 md:p-14 border border-gray-100">
          <article className="prose prose-neutral max-w-none">
            ...
            <section>
              ...
              <p>
                We collect the following details during registration or order
                placement:
              </p>
              ...
              <p>
                We may collect UPI ID, transaction IDs, and billing-related
                information. We do
                <strong> NOT</strong> store card details. All payments are
                handled securely through trusted third‑party payment gateways.
              </p>
              ...
              <p>
                We collect non-personal data such as device info, IP address,
                analytics, and crash logs to improve performance.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                We share limited data with delivery partners, payment
                processors, and operational service providers — strictly for
                service purposes. We do not share your information with
                advertisers.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Location access helps improve delivery accuracy and assign
                nearby personnel. You may disable location permissions anytime,
            ...
            <section>
              ...
              <p>
                We use encryption, secure servers, and restricted internal
                access to protect your data. Although we follow
            ...
            <section>
              ...
              <p>
                We retain your data while your account remains active or as
                required for legal and business purposes. You may request
                account deletion.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                We use third‑party tools such as payment gateways, analytics,
                and crash reporting systems.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-none pl-0">
                <li>
                  <strong>Email:</strong>
                  <a
                    href="mailto:support@govigi.com"
